...
public class Person {
	...
	private int birth_location;

	private int death_day;
	private int death_month;
	private int death_year;
	private int death_location;
	...
	public int getBirth_location() {
		return birth_location;
	}
	public void setBirth_location(int birth_location) {
		this.birth_location = birth_location;
	}
	public int getDeath_day() {
		return death_day;
	}
	public void setDeath_day(int death_day) {
		this.death_day = death_day;
	}
	public int getDeath_month() {
		return death_month;
	}
	public void setDeath_month(int death_month) {
	...
	public int getDeath_location() {
		return death_location;
	}
	public void setDeath_location(int death_location) {
