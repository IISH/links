...
public class ManagerGui extends javax.swing.JFrame
{
	...
	private void initComponents() {
		...
		//======== tpMain ========
		{
			...
			//======== pLOLC ========
			{
				...
				//---- cbCdoFamilynames ----
				cbCdoFamilynames.setSelected(true);
								...
								.addGroup(GroupLayout.Alignment.TRAILING, pLOLCLayout.createSequentialGroup()
									.addGroup(pLOLCLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
										...
										.addGroup(GroupLayout.Alignment.LEADING, pLOLCLayout.createSequentialGroup()
											...
											.addGap(42, 42, 42)
											.addGroup(pLOLCLayout.createParallelGroup()
												.addComponent(tbLOLCrefpass, GroupLayout.Alignment.TRAILING)
												.addComponent(tbLOLCrefuser, GroupLayout.Alignment.TRAILING)
												.addComponent(tbLOLCrefurl)
												.addComponent(tbLOLCrefdb))))
									.addGap(20, 20, 20))
								.addGroup(pLOLCLayout.createSequentialGroup()
									.addGroup(pLOLCLayout.createParallelGroup()
										...
										.addGroup(pLOLCLayout.createParallelGroup()
											.addGroup(pLOLCLayout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
												.addComponent(cbCdoFamilynames, GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
			...
			//======== jPanel1 ========
			{
				...
				btnStartProcessPrematch.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						btnStartProcessActionPrematch(e);
					}
				});
    ...
    public void loadProperties( PrintLogger plog, Properties properties )
    {
        ...
        */
        ...
        if( doFirstnames != null ) {
            if (doFirstnames.equals("true")) {
                cbCdoFirstnames.setSelected(true);
            } else {
                cbCdoFirstnames.setSelected(false);
            }
        }
        ...
        if( doFamilynames != null ) {
            if (doFamilynames.equals("true")) {
                cbCdoFamilynames.setSelected(true);
            } else {
                cbCdoFamilynames.setSelected(false);
            }
        }
    ...
    private void bnLOLCstartProcessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnLOLCstartProcessActionPerformed
        ...
        //if( cbCdbgFirstnames.isSelected() ) { opts.setDbgFirstnames( true ); }

        if(  cbCdoFamilynames.isSelected() ) { opts.setDoFamilynames( true ); }
        //if( cbCdbgFamilynames.isSelected() ) { opts.setDbgFamilynames( true ); }
    ...
    public void firePrematch() {
        ...
        btnStartProcessActionPrematch( null );
    }
    ...
    private void btnStartProcessActionPrematch(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnPstartProcessActionPerformed
    ...
    public static void main( String args[] )
    {
        ...
        java.awt.EventQueue.invokeLater( new Runnable() {
            ...
            public void run() {
            String timestamp1 = "10-Nov-2014 12:08";
