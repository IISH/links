 ...
 * FL-14-Oct-2019 timestamp update
 */
...
public class ManagerGui extends javax.swing.JFrame
{
	...
	private void initComponents() {
		...
		cbCdoFlagPersons = new JCheckBox();
		cbCdoFlagRegistrations = new JCheckBox();
    ...
    public void loadProperties( PrintLogger plog, Properties properties )
    {
        ...
        */
        ...
        if( doFlagPersons != null ) {
            if( doFlagPersons.equals( "true" ) ) { cbCdoFlagPersons.setSelected( true ); }
            else { cbCdoFlagPersons.setSelected( false ); }
        }
        ...
        if( doFlagDuplicateRegs != null ) {
            if( doFlagDuplicateRegs.equals( "true" ) ) { cbCdoFlagRegistrations.setSelected( true ); }
            else { cbCdoFlagRegistrations.setSelected( false ); }
        }
        ...
        dbgFlagRegistrations   = properties.getProperty( "dbgFlagRegistrations" );
        dbgFlagPersons         = properties.getProperty( "dbgFlagPersons" );
    ...
    private Options setOptions()
    {
        ...
        if( cbCdoFlagRegistrations.isSelected() ) { opts.setDoFlagRegistrations( true ); }
        else { opts.setDoFlagRegistrations( false ); }

        if( cbCdoFlagPersons.isSelected() ) { opts.setDoFlagPersons( true ); }
        else { opts.setDoFlagPersons( false ); }
       ...
       if( dbgFlagRegistrations != null ) {
           if( dbgFlagRegistrations.equals( "true" ) ) { opts.setDbgFlagRegistrations(true); }
           else { opts.setDbgFlagRegistrations(false); }
        }

        if( dbgFlagPersons != null ) {
            if( dbgFlagPersons.equals( "true" ) ) { opts.setDbgFlagPersons(true); }
            else { opts.setDbgFlagPersons(false); }
        }
	...
	public static void main( String args[] )
	{
		...
		*/
		...
		java.awt.EventQueue.invokeLater( new Runnable()
		{
			...
			{
				long threadId = Thread.currentThread().getId();
				String timestamp1 = "14-Oct-2019 12:40";
	...
	private JCheckBox cbCdoFlagPersons;
	private JCheckBox cbCdoFlagRegistrations;
