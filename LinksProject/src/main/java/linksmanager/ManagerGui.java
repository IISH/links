...
public class ManagerGui extends javax.swing.JFrame
{
    ...
    private String dbgFlagEmptyDateRegs = "";
    private String dbgFlagEmptyRoleRegs = "";
    private String dbgFlagDuplicateRegs = "";
    ...
    private void btnStartProcessMatchActionPerformed( ActionEvent ev )
    {
        ...
        try
        {
            ...
            String matchdir    = matchDirectory.getText();
            String matchscript = matchScript.getText();

            String matchPath =  matchdir + '/' + matchscript;
            String cmdline[] = new String[] { "sh", matchPath };
            ...
            msg += "For progress in the matching, see the console output, and the latest logfile in the log directory. ";
    ...
    private void initComponents() {
        ...
        cbCdoFlagEmptyRoleRegs = new JCheckBox();
        cbCdoFlagEmptyDateRegs = new JCheckBox();
        cbCdoFlagDuplicateRegs = new JCheckBox();
        ...
        //======== tpMain ========
        {
                        ...
                        .addGroup(pMainLayout.createSequentialGroup()
                            ...
                            .addGroup(pMainLayout.createParallelGroup()
                                ...
                                .addGroup(pMainLayout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                    .addGroup(pMainLayout.createParallelGroup()
                                        .addComponent(jScrollPane5, GroupLayout.DEFAULT_SIZE, 336, Short.MAX_VALUE)
                                        .addGroup(pMainLayout.createSequentialGroup()
                                            .addComponent(jLabel41)
                            ...
                            .addGroup(pCsvLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(pCsvLayout.createSequentialGroup()
                                    ...
                                    .addGroup(pCsvLayout.createParallelGroup()
                                        .addComponent(tfCSVInfo, GroupLayout.DEFAULT_SIZE, 989, Short.MAX_VALUE)
                                        .addComponent(tfCSVLineData, GroupLayout.DEFAULT_SIZE, 989, Short.MAX_VALUE)
                                        .addGroup(GroupLayout.Alignment.TRAILING, pCsvLayout.createSequentialGroup()
                                            .addGroup(pCsvLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                                                .addComponent(tfCSVFilterText, GroupLayout.DEFAULT_SIZE, 867, Short.MAX_VALUE)
                                                .addGroup(GroupLayout.Alignment.LEADING, pCsvLayout.createSequentialGroup()
                                                    .addComponent(jLabel18)
                                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                                    .addComponent(tfCSVFilterIndex, GroupLayout.DEFAULT_SIZE, 649, Short.MAX_VALUE))
                                                .addComponent(tfCSVOutputFile, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 867, Short.MAX_VALUE)
                                                .addComponent(tfCSVCsvFile, GroupLayout.DEFAULT_SIZE, 867, Short.MAX_VALUE))
                                            .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                            .addGroup(pCsvLayout.createParallelGroup()
                        ...
                        .addGroup(pCsvToDatabaseLayout.createSequentialGroup()
                            ...
                            .addGroup(pCsvToDatabaseLayout.createParallelGroup()
                                .addGroup(pCsvToDatabaseLayout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                    .addComponent(tfCTBCsvFiles, GroupLayout.DEFAULT_SIZE, 935, Short.MAX_VALUE)
                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                ...
                                .addGroup(pCsvToDatabaseLayout.createSequentialGroup()
                                    .addGroup(pCsvToDatabaseLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(pCsvToDatabaseLayout.createSequentialGroup()
                                            ...
                                            .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                            .addGroup(pCsvToDatabaseLayout.createParallelGroup()
                                                .addComponent(tfCTDDbPass, GroupLayout.DEFAULT_SIZE, 280, Short.MAX_VALUE)
                                                .addComponent(tfCTDDbUser, GroupLayout.DEFAULT_SIZE, 280, Short.MAX_VALUE)
                                                .addComponent(tfCTDDbName, GroupLayout.DEFAULT_SIZE, 280, Short.MAX_VALUE)
                                                .addComponent(tfCTDDbLocation, GroupLayout.DEFAULT_SIZE, 280, Short.MAX_VALUE)
                                                .addComponent(tfCTDPreFix, GroupLayout.DEFAULT_SIZE, 280, Short.MAX_VALUE)
                                                .addComponent(tfCTDdelay, GroupLayout.DEFAULT_SIZE, 280, Short.MAX_VALUE)))
                                    ...
                                    .addGroup(pCsvToDatabaseLayout.createParallelGroup()
                                        ...
                                        .addComponent(jScrollPane2, GroupLayout.DEFAULT_SIZE, 669, Short.MAX_VALUE)
                                        .addComponent(tfCTDLatestOutput, GroupLayout.DEFAULT_SIZE, 669, Short.MAX_VALUE)
                                        .addGroup(pCsvToDatabaseLayout.createSequentialGroup()
                                            .addGroup(pCsvToDatabaseLayout.createParallelGroup()
                                            ...
                                            .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                            .addGroup(pCsvToDatabaseLayout.createParallelGroup()
                                                .addComponent(pbDTCFile, GroupLayout.DEFAULT_SIZE, 580, Short.MAX_VALUE)
                                                .addComponent(pbDTCTotal, GroupLayout.DEFAULT_SIZE, 580, Short.MAX_VALUE)
                                                .addComponent(tfCTDLineNumber, GroupLayout.DEFAULT_SIZE, 580, Short.MAX_VALUE))))))
                            .addContainerGap())
                );
                pCsvToDatabaseLayout.setVerticalGroup(
                    pCsvToDatabaseLayout.createParallelGroup()
                        .addGroup(pCsvToDatabaseLayout.createSequentialGroup()
                            ...
                            .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                            .addGroup(pCsvToDatabaseLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                                .addComponent(jScrollPane2, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 428, Short.MAX_VALUE)
                    ...
                    pBronInternToLinksOrigineelLayout.createParallelGroup()
                        .addGroup(pBronInternToLinksOrigineelLayout.createSequentialGroup()
                            ...
                            .addGroup(pBronInternToLinksOrigineelLayout.createParallelGroup()
                                .addGroup(pBronInternToLinksOrigineelLayout.createSequentialGroup()
                                    .addGroup(pBronInternToLinksOrigineelLayout.createParallelGroup()
                                        .addComponent(tfBILODbPass, GroupLayout.DEFAULT_SIZE, 399, Short.MAX_VALUE)
                                        .addComponent(tfBILODbUser, GroupLayout.DEFAULT_SIZE, 399, Short.MAX_VALUE)
                                        .addComponent(tfBILODbLocation, GroupLayout.DEFAULT_SIZE, 399, Short.MAX_VALUE)
                                        .addComponent(tfBILOProjectName, GroupLayout.DEFAULT_SIZE, 399, Short.MAX_VALUE)
                                        .addComponent(tfBILODeleteSource, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 399, Short.MAX_VALUE)
                                        .addGroup(GroupLayout.Alignment.TRAILING, pBronInternToLinksOrigineelLayout.createSequentialGroup()
                                            .addComponent(tfBILOdelay, GroupLayout.DEFAULT_SIZE, 296, Short.MAX_VALUE)
                                            .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                ...
                                .addGroup(pBronInternToLinksOrigineelLayout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                            .addGroup(pBronInternToLinksOrigineelLayout.createParallelGroup()
                                .addComponent(jScrollPane3, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 548, Short.MAX_VALUE)
                                .addComponent(tfBILOLatestOutput, GroupLayout.DEFAULT_SIZE, 548, Short.MAX_VALUE)
                    ...
                    pBronInternToLinksOrigineelLayout.createParallelGroup()
                        .addGroup(pBronInternToLinksOrigineelLayout.createSequentialGroup()
                            ...
                            .addGroup(pBronInternToLinksOrigineelLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                                ...
                                .addComponent(jScrollPane3, GroupLayout.DEFAULT_SIZE, 553, Short.MAX_VALUE))
                            .addContainerGap())
                );
            }
            ...
            //======== pLOLC ========
            {
                ...
                //---- cbCdoFlagEmptyDateRegs ----
                cbCdoFlagEmptyDateRegs.setText("Flag Empty Date Reg's");
                cbCdoFlagEmptyDateRegs.setName("cbCdoFlagEmptyDateRegs");

                //---- cbCdoFlagDuplicateRegs ----
                cbCdoFlagDuplicateRegs.setText("Flag Duplicate Reg's");
                cbCdoFlagDuplicateRegs.setName("cbCdoFlagDuplicateRegs");
                            ...
                            .addGroup(pLOLCLayout.createParallelGroup()
                                ...
                                .addGroup(pLOLCLayout.createSequentialGroup()
                                    ...
                                    .addGroup(pLOLCLayout.createParallelGroup()
                                        ...
                                        .addGroup(pLOLCLayout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
                                            .addComponent(cbCdoFlagDuplicateRegs, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 264, Short.MAX_VALUE)
                                            .addComponent(cbCdoFlagEmptyRoleRegs, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 264, Short.MAX_VALUE)
                                            .addComponent(cbCdoFlagEmptyDateRegs, GroupLayout.DEFAULT_SIZE, 264, Short.MAX_VALUE)
                            ...
                            .addGroup(pLOLCLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(pLOLCLayout.createSequentialGroup()
                                    ...
                                    .addGroup(pLOLCLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(cbCdoFlagEmptyDateRegs))
                                    .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                    .addGroup(pLOLCLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                    ...
                                    .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                    .addGroup(pLOLCLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                        .addComponent(cbCdoFlagDuplicateRegs)
            ...
            //======== pMatch ========
            {
                ...
                //======== scrollPane1 ========
                {
                    ...
                    //---- matchTextArea ----
                    matchTextArea.setName("matchTextArea");
                    scrollPane1.setViewportView(matchTextArea);
                }
                ...
                //---- matchdir ----
                matchdir.setText("Match directory: ");
                matchdir.setName("matchdir");

                //---- matchDirectory ----
                matchDirectory.setName("matchDirectory");

                //---- matchsh ----
                matchsh.setText("Match script: ");
                matchsh.setName("matchsh");

                //---- matchScript ----
                matchScript.setName("matchScript");
                ...
                pMatchLayout.setHorizontalGroup(
                    pMatchLayout.createParallelGroup()
                        .addGroup(pMatchLayout.createSequentialGroup()
                            .addGap(30, 30, 30)
                            .addGroup(pMatchLayout.createParallelGroup()
                                .addGroup(pMatchLayout.createSequentialGroup()
                                    .addComponent(btnStartProcessMatch, GroupLayout.PREFERRED_SIZE, 1057, GroupLayout.PREFERRED_SIZE)
                                    .addGap(0, 0, Short.MAX_VALUE))
                                .addComponent(scrollPane1)
                                .addGroup(pMatchLayout.createSequentialGroup()
                                    .addGroup(pMatchLayout.createParallelGroup()
                                        .addComponent(matchdir, GroupLayout.PREFERRED_SIZE, 132, GroupLayout.PREFERRED_SIZE)
                                        .addComponent(matchsh, GroupLayout.PREFERRED_SIZE, 132, GroupLayout.PREFERRED_SIZE))
                                    .addGap(31, 31, 31)
                                    .addGroup(pMatchLayout.createParallelGroup()
                                        .addComponent(matchDirectory)
                                        .addComponent(matchScript))))
                            .addGap(30, 30, 30))
                );
                pMatchLayout.setVerticalGroup(
                    pMatchLayout.createParallelGroup()
                        .addGroup(pMatchLayout.createSequentialGroup()
                            .addGap(15, 15, 15)
                            .addGroup(pMatchLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                .addComponent(matchdir, GroupLayout.PREFERRED_SIZE, 15, GroupLayout.PREFERRED_SIZE)
                                .addComponent(matchDirectory, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                            .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                            .addGroup(pMatchLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                .addComponent(matchsh)
                                .addComponent(matchScript, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                            .addGap(16, 16, 16)
            ...
            //======== pIDS ========
            {
                ...
                //======== scrollPane2 ========
                {
                    ...
                    //---- idsTextArea ----
                    idsTextArea.setName("idsTextArea");
                    scrollPane2.setViewportView(idsTextArea);
                }

                //---- btnStartProcessIds ----
                btnStartProcessIds.setText("Start Creating IDS");
                btnStartProcessIds.setName("btnStartProcessIds");
                btnStartProcessIds.addActionListener(new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        btnStartProcessIdsActionPerformed(e);
                    }
                });

                //---- idsdir ----
                idsdir.setText("IDS directory: ");
                idsdir.setName("idsdir");

                //---- idsDirectory ----
                idsDirectory.setName("idsDirectory");

                //---- idssh ----
                idssh.setText("IDS script: ");
                idssh.setName("idssh");

                //---- idsScript ----
                idsScript.setName("idsScript");

                GroupLayout pIDSLayout = new GroupLayout(pIDS);
                pIDS.setLayout(pIDSLayout);
                pIDSLayout.setHorizontalGroup(
                    pIDSLayout.createParallelGroup()
                        .addGroup(pIDSLayout.createSequentialGroup()
                            .addGap(30, 30, 30)
                            .addGroup(pIDSLayout.createParallelGroup()
                                .addGroup(pIDSLayout.createSequentialGroup()
                                    .addComponent(btnStartProcessIds, GroupLayout.PREFERRED_SIZE, 1057, GroupLayout.PREFERRED_SIZE)
                                    .addGap(0, 0, Short.MAX_VALUE))
                                .addComponent(scrollPane2)
                                .addGroup(pIDSLayout.createSequentialGroup()
                                    .addGroup(pIDSLayout.createParallelGroup()
                                        .addComponent(idsdir, GroupLayout.PREFERRED_SIZE, 132, GroupLayout.PREFERRED_SIZE)
                                        .addComponent(idssh, GroupLayout.PREFERRED_SIZE, 132, GroupLayout.PREFERRED_SIZE))
                                    .addGap(31, 31, 31)
                                    .addGroup(pIDSLayout.createParallelGroup()
                                        .addComponent(idsDirectory)
                                        .addComponent(idsScript))))
                            .addGap(30, 30, 30))
                );
                pIDSLayout.setVerticalGroup(
                    pIDSLayout.createParallelGroup()
                        .addGroup(pIDSLayout.createSequentialGroup()
                            .addGap(15, 15, 15)
                            .addGroup(pIDSLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                .addComponent(idsdir, GroupLayout.PREFERRED_SIZE, 15, GroupLayout.PREFERRED_SIZE)
                                .addComponent(idsDirectory, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                            .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                            .addGroup(pIDSLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                .addComponent(idssh)
                                .addComponent(idsScript, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                            .addGap(16, 16, 16)
                            .addComponent(scrollPane2, GroupLayout.PREFERRED_SIZE, 483, GroupLayout.PREFERRED_SIZE)
                            .addGap(18, 18, 18)
                            .addComponent(btnStartProcessIds)
                            .addContainerGap(34, Short.MAX_VALUE))
                );
            }
    ...
    public void loadProperties( PrintLogger plog, Properties properties )
    {
        ...
        */
        ...
        String doFlagEmptyDateRegs = properties.getProperty( "doFlagEmptyDateRegs" );
        if( doFlagEmptyDateRegs != null ) {
            if( doFlagEmptyDateRegs.equals( "true" ) ) { cbCdoFlagEmptyDateRegs.setSelected( true ); }
            else { cbCdoFlagEmptyDateRegs.setSelected( false ); }
        }

        // Remove Empty Role Regs
        String doFlagEmptyRoleRegs = properties.getProperty( "doFlagEmptyRoleRegs" );
        if( doFlagEmptyRoleRegs != null ) {
            if( doFlagEmptyRoleRegs.equals( "true" ) ) { cbCdoFlagEmptyRoleRegs.setSelected( true ); }
            else { cbCdoFlagEmptyRoleRegs.setSelected( false ); }
        }

        // Remove Duplicate Regs
        String doFlagDuplicateRegs = properties.getProperty( "doFlagDuplicateRegs" );
        if( doFlagDuplicateRegs != null ) {
            if( doFlagDuplicateRegs.equals( "true" ) ) { cbCdoFlagDuplicateRegs.setSelected( true ); }
            else { cbCdoFlagDuplicateRegs.setSelected( false ); }
        }
        ...
        dbgFlagEmptyDateRegs   = properties.getProperty( "dbgFlagEmptyDateRegs" );
        dbgFlagEmptyRoleRegs   = properties.getProperty( "dbgFlagEmptyRoleRegs" );
        dbgFlagDuplicateRegs   = properties.getProperty( "dbgFlagDuplicateRegs" );
        ...
        String matchdir = properties.getProperty( "matchDir" );
        if( matchdir != null ) { matchDirectory.setText( matchdir ); }

        String matchscript = properties.getProperty( "matchScript" );
        if( matchscript != null ) { matchScript.setText( matchscript ); }


        String idsdir = properties.getProperty( "idsDir" );
        if( idsdir != null ) { idsDirectory.setText( idsdir ); }

        String idsscript = properties.getProperty( "idsScript" );
        if( idsscript != null ) { idsScript.setText( idsscript ); }
    ...
    private Options setOptions()
    {
        ...
        if( cbCdoFlagEmptyDateRegs.isSelected() ) { opts.setDoFlagEmptyDateRegs( true ); }
        else { opts.setDoFlagEmptyDateRegs( false ); }

        if( cbCdoFlagEmptyRoleRegs.isSelected() ) { opts.setDoFlagEmptyRoleRegs( true ); }
        else { opts.setDoFlagEmptyRoleRegs( false ); }

        if( cbCdoFlagDuplicateRegs.isSelected() ) { opts.setDoFlagDuplicateRegs( true ); }
        else { opts.setDoFlagDuplicateRegs( false ); }
        ...
        if( dbgFlagEmptyDateRegs != null ) {
            if( dbgFlagEmptyDateRegs.equals( "true" ) ) { opts.setDbgFlagEmptyDateRegs(true); }
            else { opts.setDbgFlagEmptyDateRegs(false); }
        }

        if( dbgFlagEmptyRoleRegs != null ) {
            if( dbgFlagEmptyRoleRegs.equals( "true" ) ) { opts.setDbgFlagEmptyRoleRegs(true); }
            else { opts.setDbgFlagEmptyRoleRegs(false); }
        }

        if( dbgFlagDuplicateRegs != null ) {
            if( dbgFlagDuplicateRegs.equals( "true" ) ) { opts.setDbgFlagDuplicateRegs(true); }
            else { opts.setDbgFlagDuplicateRegs(false); }
        }
    ...
    public static void main( String args[] )
    {
        ...
        */
        ...
        java.awt.EventQueue.invokeLater( new Runnable()
        {
            ...
            {
            long threadId = Thread.currentThread().getId();
            String timestamp1 = "15-Nov-2016 16:47";
    ...
    private JCheckBox cbCdoFlagEmptyRoleRegs;
    private JCheckBox cbCdoFlagEmptyDateRegs;
    private JCheckBox cbCdoFlagDuplicateRegs;
