...
public class ManagerGui extends javax.swing.JFrame
{
    ...
    private void btnStartProcessMatchActionPerformed( ActionEvent ev )
    {
        ...
        String jarParams = db_url + " " + db_user + " " + db_pass + " " + max_threads;
        String jarString = jarPath + " " + jarParams;
        System.out.println( jarString );

        try {
            Process ps = Runtime.getRuntime().exec( new String[] { "java", "-jar", jarString } );
            ps.waitFor();
    ...
    public static void main( String args[] )
    {
        ...
        java.awt.EventQueue.invokeLater( new Runnable() {
            ...
            public void run() {
            String timestamp1 = "11-Nov-2014 09:54";
